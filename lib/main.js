...
Collection = (function() {
  ...
  Collection.prototype.ready = function(callback) {
    return setTimeout((function(_this) {
      return function() {
        var collection;
        collection = _this.el.collection;
        if (!(collection && collection.name && collection.data)) {
          return _this.ready.call(_this, callback);
        } else {
          _this.data = _this.el.collection.data;
          _this.schema = {};
  ...
  Collection.prototype.findByPath = function(path, data) {
    ...
    replacer = (function(_this) {
      return function(match) {
        ...
        if (value !== void 0) {
          ...
          if ((typeof ason !== "undefined" && ason !== null ? ason.env : void 0) === "production") {
            return "";
          }
          return match;
        }
